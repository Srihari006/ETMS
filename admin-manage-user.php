              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="">
                      <input type="text" placeholder="Enter Employee Name" name="em_fullname" list="expense" class="form-control rounded-0" id="default" required>
                    </div>
                  </div>
                   <div class="form-group">
                    <label class="control-label text-p-reset">Username</label>
                    <div class="">
                      <input type="text" placeholder="Enter Employee username" name="em_username" class="form-control rounded-0" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label text-p-reset">Email</label>
                    <div class="">
                      <input type="email" placeholder="Enter Employee Email" name="em_email" class="form-control rounded-0" required>
                    </div>
                  </div>
