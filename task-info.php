                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <div class="input-group">
                                            <input type="text" placeholder="Task Title" id="task_title" name="task_title" list="task_titles" class="form-control rounded-0" required>
                                            <datalist id="task_titles">
                                                <option>UI/UX Updates</option>
                                                <option>Security Bug</option>
                                                <option>Hardware performance tuning and optimization</option>
                                                <option>Hardware inventory audit and management</option>
                                                <option>Implement data analytics for [software/product name]</option>
                                                <option>Conduct code review and provide feedback</option>
                                                <option>Design and implement a user interface for [software/product name]</option>
                                                <option>Provide technical support for hardware-related issues</option>
                                                <option>Upgrade software dependencies in current project</option>
                                                <option>technical documentation for your current project</option>
                                            </datalist>
                                        </div>
                                    </div>
                                </div>
